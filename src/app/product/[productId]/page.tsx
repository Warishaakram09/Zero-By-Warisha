...
//             <button
//               onClick={addToCart}
//               className="mt-6 w-full sm:w-auto bg-black text-white px-6 py-3 rounded-lg"
//             >
//               Add to Cart
//             </button>
//           </div>
...
//       {cartOpen && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
//           <div className="fixed right-0 top-0 w-full sm:w-96 bg-white h-full shadow-lg flex flex-col">
//             <div className="flex justify-between p-4 border-b">
//               <h2 className="text-xl font-bold">Your Cart</h2>
//               <button onClick={() => setCartOpen(false)}>
//                 <XMarkIcon className="w-6 h-6" />
